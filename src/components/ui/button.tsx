...
const buttonVariants = cva('button', { variants: { variant: { default: 'button-primary', outline: 'button-outline', link: 'button-link' }, size: { default: '', sm: 'button-small' } }, defaultVariants: { variant: 'default', size: 'default' } });
